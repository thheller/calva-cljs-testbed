...
Note: Hot reloading does not work at all with this solution, at least not when using compiled cljs directly for the entry point, and not a JS file (need to test with the JS entry point again).
